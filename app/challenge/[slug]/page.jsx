...
async function getChallenge(slug) {
  ...
  const response = await fetch(`${url}/rest/v1/challenges?slug=eq.${encodeURIComponent(slug)}&select=*,challenge_tests(*)&limit=1`, { headers: { apikey: key }, cache: "no-store" });
